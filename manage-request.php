                    ...
                    <div class="main-page">
                        <div class="container-fluid">
                            <div class="row page-title-div">
                                <div class="col-md-6">
                                    <h2 class="title">Manage Request</h2>
                                        ...
                                        <?php } ?>
                                            <div class="panel-body p-20">
                                                ...
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
<?php $sql = "SELECT tblstudentss.StudentName,tblstudentss.StudentNumber,tblstudentss.RegDate,tblstudentss.StudentId,tblstudentss.Status,tblform.ClassName,tblform.Section from tblstudentss join tblform on tblform.id=tblstudentss.ClassId";
