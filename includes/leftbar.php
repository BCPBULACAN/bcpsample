<div class="left-sidebar bg-black-300 box-shadow ">
                        <div class="sidebar-content">
                            <div class="user-info closed">
                                <img src="http://placehold.it/90/c2c2c2?text=User" alt="BCP" class="img-circle profile-img">
                                <h6 class="title">BCP</h6>
                                <small class="info">BEST LINK COLLEGE</small>
                            </div>
                            ...
                            <div class="sidebar-nav">
                                <ul class="side-nav color-gray">
                                    <li class="nav-header">
                                        <span class="">COLLEGE DEPARTMENT</span>
                                    </li>
                                    <li>
                                        <a href="dashboard.php"><i class="fa fa-dashboard"></i> <span>College Dashboard</span> </a>
...
<li class="has-children">
                                        <a href="#"><i class="fa fa-file-text"></i> <span>Request</span> <i class="fa fa-angle-right arrow"></i></a>
                                        <ul class="child-nav">
                                        <li><a href="manage-request.php"><i class="fa fa-bars"></i> <span>Manage</span></a></li>
</ul>
