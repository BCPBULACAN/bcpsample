...
$dob=$_POST['dob']; 
$status=$_POST['status'];
$sql="update tblstudents set StudentName=:studentname,StudentNumber=:roolid,StudentEmail=:studentemail,Gender=:gender,DOB=:dob,Status=:status where StudentId=:stid ";
...
<div class="col-sm-10">
<input type="text" name="studentnumber" class="form-control" id="studentnumber" value="<?php echo htmlentities($result->StudentNumber)?>" maxlength="5" required="required" autocomplete="off">
</div>
</div>
